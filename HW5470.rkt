...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname HW5470) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
(define resolve
  (lambda (varName env)
    (cond
      ((null? env) #f)
...
(define createVariables
  (lambda (lst lst2)
    (cond
      ((null? lst) '())
      (else (cons (list (car lst) (run-parsed-code (car lst2) env)) (createVariables (cdr lst) (cdr lst2)))
      ))))
